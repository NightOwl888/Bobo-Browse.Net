    ...
    public class BoboSearcher2 : BoboSearcher
    {
        ...
        protected FacetValidator CreateFacetValidator()
        {
            ...
            foreach (FacetHitCollector facetCollector in facetCollectors)
            {
                ...
                {
                    facetCollector.More = facetCollector.PostDocIDSetIterator.Next();
                    facetCollector.Doc = (facetCollector.More ? facetCollector.PostDocIDSetIterator.Doc() : int.MaxValue);
