...
namespace BoboBrowse.Facets.impl
{
    ...
    {
        private static log4net.ILog logger = LogManager.GetLogger(typeof(RangeFacetHandler));
        ...
        {
            return new RangeFacetCountCollector(name, dataCache, ospec, predefinedRanges, autoRange);
        }
