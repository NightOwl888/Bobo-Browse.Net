...
{
    ///<summary>Browse selection. </summary>
    [Serializable]
    public class BrowseSelection
    {
        ...
        public BrowseSelection(string fieldName)
        {
            ...
            notValues = new List<string>();

            FieldName = fieldName;
            SelectionOperation = ValueOperation.ValueOperationOr;
            SelectionProperties = new Properties();
        }
        ...
        ///<summary>Is strict applied for counting. Used if the field is of type <b><i>path</i></b>. </summary>
