...
namespace BoboBrowse.Api
{
    ...
    public class BoboBrowser : BoboSearcher2, IBrowsable
    {
        ...
        private readonly Dictionary<string, FacetHandler> runtimeFacetHandlerMap;

        private static ILog logger = LogManager.GetLogger(typeof(BoboBrowser));

        public new BoboIndexReader GetIndexReader()
        {
            return reader;
        }
        ...
        public virtual void SetFacetHandler(FacetHandler facetHandler)
        {
            ...
            BoboIndexReader indexReader = (BoboIndexReader)GetIndexReader();
